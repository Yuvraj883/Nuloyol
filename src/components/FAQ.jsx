        ...
        <>
            <div className='FAQ'>
                <div className='FAQ-questions'>
                    <h1>FAQs.</h1>
                    <div className={question1==='true'?'question active':'question'} onClick={handleSetQuestion1}>What is Chowdeck?</div>
                    <div className={question2==='true'?'question active':'question'}  onClick={handleSetQuestion2}>What locations do we currently deliver to?</div>
                    <div className={question3==='true'?'question active':'question'} onClick={handleSetQuestion3}>What is Chowdeck wallet?</div>
                    <div className={question4==='true'?'question active':'question'} onClick={handleSetQuestion4}>What is Chowscore?</div>
                    <div className={question5==='true'?'question active':'question'} onClick={handleSetQuestion5}>What is Service fee?</div>
